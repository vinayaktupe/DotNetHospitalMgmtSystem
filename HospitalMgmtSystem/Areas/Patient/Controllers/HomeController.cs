...
namespace HospitalMgmtSystem.Areas.Patient.Controllers
{
    [Area("Patient")]
    public class HomeController : Controller
    {
        ...
        public HomeController(IPatientService patientService, ICasePaperService casePaperService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            var cases = await _casePaperService
                ...
                paper.Patients.Users.Email == User.Identity.Name && 
