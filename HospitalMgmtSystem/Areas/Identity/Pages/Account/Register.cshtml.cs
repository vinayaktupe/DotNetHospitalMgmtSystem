...
namespace HospitalMgmtSystem.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        //    {
        //        var user = new ApplicationUser { FirstName = Input.FirstName, LastName = Input.LastName, UserName = Input.Email, Email = Input.Email, Number = Input.Number, Address = Input.Address };
